      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-[#111A19] rounded-lg p-8 shadow-md border border-[#284139]">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-[#1B1B1B] p-6 rounded-lg shadow-md border border-[#284139] transition-all duration-300 hover:shadow-lg">
              <h3 className="text-xl font-semibold text-[#809076] mb-4">Links</h3>
              <div className="flex flex-wrap gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="bg-[#111A19] hover:bg-[#1B1B1B] p-3 rounded-lg transition-all duration-300 hover:shadow-md border border-[#284139] hover:border-[#809076] group"
                    title={link.name}
                  >
